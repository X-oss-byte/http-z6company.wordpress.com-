...
function render_block_core_search( $attributes, $content, $block ) {
	...
	$color_classes       = get_structured_color_classes_for_block_core_search( $attributes );
	$typography_classes  = get_structured_typography_classes_for_block_core_search( $attributes );
...
function get_typography_classes_for_block_core_search( $attributes ) {
	$class_names = get_structured_typography_classes_for_block_core_search( $attributes );
 ...
 */
function get_structured_typography_classes_for_block_core_search( $attributes ) {
...
function get_color_classes_for_block_core_search( $attributes ) {
	$class_names = get_structured_color_classes_for_block_core_search( $attributes );
 ...
 */
function get_structured_color_classes_for_block_core_search( $attributes ) {
	$classnames = array();
